...
### [1] [Joint Transmit and Receive Antenna Orientation Design for Secure MIMO Communications](https://arxiv.org/abs/2605.14272)
*Ailing Zheng,Qingqing Wu,Xingxiang Peng,Qiaoyan Peng,Ziyuan Zheng,Yuxuan Chen,Wen Chen*

Main category: cs.IT

TL;DR: This paper proposes using rotatable antennas (RAs) to enhance physical layer security in MIMO systems by dynamically optimizing antenna orientations, achieving significant secrecy rate gains over fixed-orientation schemes.


<details>
  <summary>Details</summary>
Motivation: Conventional physical layer security is limited by fixed-orientation antennas, which cannot dynamically adapt to channel conditions to suppress eavesdropping.

Method: Jointly optimizes transmit beamforming, artificial noise covariance, and RA orientations via an alternating optimization algorithm (MMSE reformulation + Riemannian Frank-Wolfe method) for both SISO and MIMO cases.

Result: The proposed RA-aided scheme converges rapidly and achieves significant secrecy rate gains over conventional fixed-orientation schemes.

Conclusion: Rotatable antennas are an effective approach to proactively reshape MIMO channels for enhanced secure communication in 6G networks.
